...
train_data = dset.CIFAR10(root='/home/xiaoda/data', train=True, download=True, transform=train_transform)
...
def train(train_queue,valid_queue, model, criterion, optimizer_arch, optimizer_model,lr_arch):
...
for epoch in range(opt.epochs):
    ...
    # training
    train_acc_top1, train_acc_top5 , train_valoss,train_poloss = train(train_queue, valid_queue, model,criterion, optimizer_arch,optimizer_model,opt.arch_learning_rate)
